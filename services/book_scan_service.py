    ...
    def scan_single_book(db_type, book_id):
        ...
        try:
            ...
            if file_format_lower in ('epub', 'pdf') and not defer_epub_metadata:
                embedded_meta = parse_embedded_metadata(file_path, file_format, is_remote=is_remote_file)
            ...
            if defer_epub_metadata and not epub_opf_read.get('parsed'):
                ...
                embedded_meta = parse_embedded_metadata(file_path, 'epub', is_remote=False)
            if embedded_meta:
