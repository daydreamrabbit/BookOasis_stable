...
PUBLIC_UI_SETTING_KEYS = (
    ...
    'SHOW_METADATA_CONNECTION_STATUS',
    'SMART_RECOMMEND_ENABLED',
    'BOOK_RECOMMEND_ENABLED',
    'HOME_DASHBOARD_PLUGIN_MODE',
    'DETAIL_VIEW_PROVIDER_GENERAL',
    'DETAIL_VIEW_PROVIDER_ADULT',
    'DETAIL_VIEW_PROVIDER_AUDIOBOOK',
    'DETAIL_VIEW_PROVIDER_VIDEO',
)
