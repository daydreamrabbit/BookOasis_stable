...
def process_folder_task(root, files, force, db_meta_full, db_offsets_cached, db_folder_mtimes, is_remote=False, library_id=None, db_files_cache=None, library_root=None, gdrive_file_ids=None, db_type=None, db_book_ids=None, db_banner_missing=None, db_banner_images=None, use_folder_cover=False, db_cover_images=None, progress_callback=None, db_metadata_title_unchecked=None):
        ...
        if skip:
            ...
            try:
                ...
                if (
                    ...
                    embedded_meta = parse_embedded_metadata(full_path, file_format, is_remote=is_remote)
                    if embedded_meta:
                ...
                if defer_local_epub_metadata:
                    if not epub_opf_read.get('parsed'):
                        ...
                        epub_embedded_meta = parse_embedded_metadata(full_path, 'epub', is_remote=False)
