...
CREATE TABLE IF NOT EXISTS libraries (
    ...
    cover_aspect_ratio VARCHAR(10) DEFAULT '4:3',
    hide_title INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS books (
    ...
    document_series_name VARCHAR(500) DEFAULT NULL,
    document_volume_index DOUBLE DEFAULT NULL,
    document_volume_count INT DEFAULT NULL,
    author VARCHAR(500),
    isbn VARCHAR(100),
